...
func (x *TokenFreezeAccountTransactionBody) Reset() {
	*x = TokenFreezeAccountTransactionBody{}
	if protoimpl.UnsafeEnabled {
		mi := &file_TokenFreezeAccount_proto_msgTypes[0]
...
func (*TokenFreezeAccountTransactionBody) Descriptor() ([]byte, []int) {
	return file_TokenFreezeAccount_proto_rawDescGZIP(), []int{0}
}
...
var file_TokenFreezeAccount_proto_rawDesc = []byte{
	0x0a, 0x18, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x46, 0x72, 0x65, 0x65, 0x7a, 0x65, 0x41, 0x63, 0x63,
	...
	0x6f, 0x74, 0x6f, 0x22, 0x75, 0x0a, 0x21, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x46, 0x72, 0x65, 0x65,
	...
	0x44, 0x52, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x26, 0x0a, 0x22, 0x63, 0x6f,
...
var (
	file_TokenFreezeAccount_proto_rawDescOnce sync.Once
	file_TokenFreezeAccount_proto_rawDescData = file_TokenFreezeAccount_proto_rawDesc
)

func file_TokenFreezeAccount_proto_rawDescGZIP() []byte {
	file_TokenFreezeAccount_proto_rawDescOnce.Do(func() {
		file_TokenFreezeAccount_proto_rawDescData = protoimpl.X.CompressGZIP(file_TokenFreezeAccount_proto_rawDescData)
	})
	return file_TokenFreezeAccount_proto_rawDescData
}

var file_TokenFreezeAccount_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_TokenFreezeAccount_proto_goTypes = []interface{}{
...
var file_TokenFreezeAccount_proto_depIdxs = []int32{
...
func init() { file_TokenFreezeAccount_proto_init() }
func file_TokenFreezeAccount_proto_init() {
	if File_TokenFreezeAccount_proto != nil {
		return
	}
	file_BasicTypes_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_TokenFreezeAccount_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_TokenFreezeAccount_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_TokenFreezeAccount_proto_goTypes,
		DependencyIndexes: file_TokenFreezeAccount_proto_depIdxs,
		MessageInfos:      file_TokenFreezeAccount_proto_msgTypes,
	}.Build()
	File_TokenFreezeAccount_proto = out.File
	file_TokenFreezeAccount_proto_rawDesc = nil
	file_TokenFreezeAccount_proto_goTypes = nil
	file_TokenFreezeAccount_proto_depIdxs = nil
}
