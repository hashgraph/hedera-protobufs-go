...
type CryptoCreateTransactionBody struct {
	...
	EvmAddress []byte `protobuf:"bytes,20,opt,name=evm_address,json=evmAddress,proto3" json:"evm_address,omitempty"`
}
...
func (x *CryptoCreateTransactionBody) GetAutoRenewAccount() *AccountID {
	if x != nil {
...
func (x *CryptoCreateTransactionBody) GetEvmAddress() []byte {
	if x != nil {
		return x.EvmAddress
	}
	return nil
...
var file_crypto_create_proto_rawDesc = []byte{
	...
	0xfc, 0x06, 0x0a, 0x1b, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x12, 0x3e, 0x0a, 0x12, 0x61, 0x75, 0x74, 0x6f, 0x5f, 0x72, 0x65, 0x6e, 0x65, 0x77, 0x5f, 0x61,
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x13, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70,
	...
	0x14, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x65, 0x76, 0x6d, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x42, 0x0b, 0x0a, 0x09, 0x73, 0x74, 0x61, 0x6b, 0x65, 0x64, 0x5f, 0x69, 0x64, 0x42, 0x26,
...
var file_crypto_create_proto_depIdxs = []int32{
	...
	2, // 7: proto.CryptoCreateTransactionBody.auto_renew_account:type_name -> proto.AccountID
