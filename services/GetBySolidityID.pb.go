...
func (x *GetBySolidityIDQuery) Reset() {
	*x = GetBySolidityIDQuery{}
	if protoimpl.UnsafeEnabled {
		mi := &file_GetBySolidityID_proto_msgTypes[0]
...
func (*GetBySolidityIDQuery) Descriptor() ([]byte, []int) {
	return file_GetBySolidityID_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetBySolidityIDResponse) Reset() {
	*x = GetBySolidityIDResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_GetBySolidityID_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetBySolidityIDResponse) Descriptor() ([]byte, []int) {
	return file_GetBySolidityID_proto_rawDescGZIP(), []int{1}
}
...
var file_GetBySolidityID_proto_rawDesc = []byte{
	0x0a, 0x15, 0x47, 0x65, 0x74, 0x42, 0x79, 0x53, 0x6f, 0x6c, 0x69, 0x64, 0x69, 0x74, 0x79, 0x49,
	0x44, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x10,
	...
	0x64, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x62, 0x0a, 0x14, 0x47, 0x65, 0x74,
	...
	0x0a, 0x73, 0x6f, 0x6c, 0x69, 0x64, 0x69, 0x74, 0x79, 0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x73, 0x6f, 0x6c, 0x69, 0x64, 0x69, 0x74, 0x79, 0x49, 0x44, 0x22, 0xd2, 0x01,
	0x0a, 0x17, 0x47, 0x65, 0x74, 0x42, 0x79, 0x53, 0x6f, 0x6c, 0x69, 0x64, 0x69, 0x74, 0x79, 0x49,
	0x44, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2d, 0x0a, 0x06, 0x68, 0x65, 0x61,
	...
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x44, 0x12, 0x25, 0x0a, 0x06, 0x66, 0x69, 0x6c, 0x65,
	0x49, 0x44, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2e, 0x46, 0x69, 0x6c, 0x65, 0x49, 0x44, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x65, 0x49, 0x44, 0x12,
	0x31, 0x0a, 0x0a, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x49, 0x44, 0x18, 0x04, 0x20,
	...
	0x49, 0x44, 0x42, 0x26, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e, 0x68, 0x65, 0x64, 0x65, 0x72, 0x61,
...
var (
	file_GetBySolidityID_proto_rawDescOnce sync.Once
	file_GetBySolidityID_proto_rawDescData = file_GetBySolidityID_proto_rawDesc
)

func file_GetBySolidityID_proto_rawDescGZIP() []byte {
	file_GetBySolidityID_proto_rawDescOnce.Do(func() {
		file_GetBySolidityID_proto_rawDescData = protoimpl.X.CompressGZIP(file_GetBySolidityID_proto_rawDescData)
	})
...
func init() { file_GetBySolidityID_proto_init() }
func file_GetBySolidityID_proto_init() {
	if File_GetBySolidityID_proto != nil {
		return
	}
	...
	if !protoimpl.UnsafeEnabled {
		file_GetBySolidityID_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_GetBySolidityID_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_GetBySolidityID_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_GetBySolidityID_proto_goTypes,
		DependencyIndexes: file_GetBySolidityID_proto_depIdxs,
		MessageInfos:      file_GetBySolidityID_proto_msgTypes,
	}.Build()
	File_GetBySolidityID_proto = out.File
	file_GetBySolidityID_proto_rawDesc = nil
	file_GetBySolidityID_proto_goTypes = nil
	file_GetBySolidityID_proto_depIdxs = nil
}
