...
type CryptoUpdateTransactionBody struct {
	...
	AutoRenewAccount *AccountID `protobuf:"bytes,19,opt,name=auto_renew_account,json=autoRenewAccount,proto3" json:"auto_renew_account,omitempty"`
	// Types that are assignable to VirtualAddressUpdate:
	//	*CryptoUpdateTransactionBody_Add
	//	*CryptoUpdateTransactionBody_Remove
	VirtualAddressUpdate isCryptoUpdateTransactionBody_VirtualAddressUpdate `protobuf_oneof:"virtual_address_update"`
}
...
func (x *CryptoUpdateTransactionBody) GetAutoRenewAccount() *AccountID {
	if x != nil {
...
func (m *CryptoUpdateTransactionBody) GetVirtualAddressUpdate() isCryptoUpdateTransactionBody_VirtualAddressUpdate {
	if m != nil {
		return m.VirtualAddressUpdate
	}
	return nil
}

func (x *CryptoUpdateTransactionBody) GetAdd() *VirtualAddress {
	if x, ok := x.GetVirtualAddressUpdate().(*CryptoUpdateTransactionBody_Add); ok {
		return x.Add
	}
	return nil
}

func (x *CryptoUpdateTransactionBody) GetRemove() []byte {
	if x, ok := x.GetVirtualAddressUpdate().(*CryptoUpdateTransactionBody_Remove); ok {
		return x.Remove
	}
	return nil
}
...
type isCryptoUpdateTransactionBody_VirtualAddressUpdate interface {
	isCryptoUpdateTransactionBody_VirtualAddressUpdate()
}

type CryptoUpdateTransactionBody_Add struct {
	//*
	// The virtual address to be added.
	Add *VirtualAddress `protobuf:"bytes,20,opt,name=add,proto3,oneof"`
}

type CryptoUpdateTransactionBody_Remove struct {
	//*
	// The 20-byte EVM address of the virtual address that is being removed.
	Remove []byte `protobuf:"bytes,21,opt,name=remove,proto3,oneof"`
}

func (*CryptoUpdateTransactionBody_Add) isCryptoUpdateTransactionBody_VirtualAddressUpdate() {}

func (*CryptoUpdateTransactionBody_Remove) isCryptoUpdateTransactionBody_VirtualAddressUpdate() {}
...
var file_crypto_update_proto_rawDesc = []byte{
	...
	0x22, 0xf8, 0x0a, 0x0a, 0x1b, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x6e, 0x65, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x12, 0x3e, 0x0a, 0x12, 0x61, 0x75, 0x74, 0x6f,
	0x5f, 0x72, 0x65, 0x6e, 0x65, 0x77, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x13,
	...
	,
...
var file_crypto_update_proto_goTypes = []interface{}{
	...
	(*VirtualAddress)(nil),              // 9: proto.VirtualAddress
}
var file_crypto_update_proto_depIdxs = []int32{
	...
	1,  // 12: proto.CryptoUpdateTransactionBody.auto_renew_account:type_name -> proto.AccountID
	9,  // 13: proto.CryptoUpdateTransactionBody.add:type_name -> proto.VirtualAddress
...
func file_crypto_update_proto_init() {
	...
	file_crypto_update_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*CryptoUpdateTransactionBody_Add)(nil),
		(*CryptoUpdateTransactionBody_Remove)(nil),
	}
	type x struct{}
