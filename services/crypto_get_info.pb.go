...
type CryptoGetInfoResponse_AccountInfo struct {
	...
	GrantedCryptoAllowances []*GrantedCryptoAllowance `protobuf:"bytes,21,rep,name=granted_crypto_allowances,json=grantedCryptoAllowances,proto3" json:"granted_crypto_allowances,omitempty"`
	//*
	// All of the non-fungible token allowances approved by the account owner.
	GrantedNftAllowances []*GrantedNftAllowance `protobuf:"bytes,22,rep,name=granted_nft_allowances,json=grantedNftAllowances,proto3" json:"granted_nft_allowances,omitempty"`
	//*
	// All of the fungible token allowances approved by the account owner.
	GrantedTokenAllowances []*GrantedTokenAllowance `protobuf:"bytes,23,rep,name=granted_token_allowances,json=grantedTokenAllowances,proto3" json:"granted_token_allowances,omitempty"`
}
...
func (x *CryptoGetInfoResponse_AccountInfo) GetGrantedCryptoAllowances() []*GrantedCryptoAllowance {
	if x != nil {
...
func (x *CryptoGetInfoResponse_AccountInfo) GetGrantedNftAllowances() []*GrantedNftAllowance {
	if x != nil {
...
func (x *CryptoGetInfoResponse_AccountInfo) GetGrantedTokenAllowances() []*GrantedTokenAllowance {
	if x != nil {
...
var file_crypto_get_info_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x44, 0x22, 0x99, 0x0a, 0x0a, 0x15,
	...
	0x1a, 0x84, 0x09, 0x0a, 0x0b, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x15, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x47, 0x72,
	...
	0x6f, 0x77, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x18, 0x16, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e,
	...
	0x5f, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x18, 0x17, 0x20, 0x03, 0x28,
	...
	0x6f, 0x77, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x42, 0x26, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e, 0x68,
...
var file_crypto_get_info_proto_goTypes = []interface{}{
	...
	(*GrantedCryptoAllowance)(nil),            // 11: proto.GrantedCryptoAllowance
	(*GrantedNftAllowance)(nil),               // 12: proto.GrantedNftAllowance
	(*GrantedTokenAllowance)(nil),             // 13: proto.GrantedTokenAllowance
}
var file_crypto_get_info_proto_depIdxs = []int32{
	...
	11, // 11: proto.CryptoGetInfoResponse.AccountInfo.granted_crypto_allowances:type_name -> proto.GrantedCryptoAllowance
	12, // 12: proto.CryptoGetInfoResponse.AccountInfo.granted_nft_allowances:type_name -> proto.GrantedNftAllowance
	13, // 13: proto.CryptoGetInfoResponse.AccountInfo.granted_token_allowances:type_name -> proto.GrantedTokenAllowance
