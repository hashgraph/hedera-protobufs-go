...
func (x *CryptoGetLiveHashQuery) Reset() {
	*x = CryptoGetLiveHashQuery{}
	if protoimpl.UnsafeEnabled {
		mi := &file_CryptoGetLiveHash_proto_msgTypes[0]
...
func (*CryptoGetLiveHashQuery) Descriptor() ([]byte, []int) {
	return file_CryptoGetLiveHash_proto_rawDescGZIP(), []int{0}
}
...
func (x *CryptoGetLiveHashResponse) Reset() {
	*x = CryptoGetLiveHashResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_CryptoGetLiveHash_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CryptoGetLiveHashResponse) Descriptor() ([]byte, []int) {
	return file_CryptoGetLiveHash_proto_rawDescGZIP(), []int{1}
}
...
var file_CryptoGetLiveHash_proto_rawDesc = []byte{
	0x0a, 0x17, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x76, 0x65, 0x48,
	...
	0x65, 0x61, 0x64, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x17, 0x43, 0x72, 0x79,
	0x70, 0x74, 0x6f, 0x41, 0x64, 0x64, 0x4c, 0x69, 0x76, 0x65, 0x48, 0x61, 0x73, 0x68, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x88, 0x01, 0x0a, 0x16, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x47,
	0x65, 0x74, 0x4c, 0x69, 0x76, 0x65, 0x48, 0x61, 0x73, 0x68, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12,
	...
	0x77, 0x0a, 0x19, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x76, 0x65,
	0x48, 0x61, 0x73, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2d, 0x0a, 0x06,
	...
	0x64, 0x65, 0x72, 0x52, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x2b, 0x0a, 0x08, 0x6c,
	0x69, 0x76, 0x65, 0x48, 0x61, 0x73, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4c, 0x69, 0x76, 0x65, 0x48, 0x61, 0x73, 0x68, 0x52, 0x08,
	0x6c, 0x69, 0x76, 0x65, 0x48, 0x61, 0x73, 0x68, 0x42, 0x26, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e,
...
var (
	file_CryptoGetLiveHash_proto_rawDescOnce sync.Once
	file_CryptoGetLiveHash_proto_rawDescData = file_CryptoGetLiveHash_proto_rawDesc
)

func file_CryptoGetLiveHash_proto_rawDescGZIP() []byte {
	file_CryptoGetLiveHash_proto_rawDescOnce.Do(func() {
		file_CryptoGetLiveHash_proto_rawDescData = protoimpl.X.CompressGZIP(file_CryptoGetLiveHash_proto_rawDescData)
	})
...
func init() { file_CryptoGetLiveHash_proto_init() }
func file_CryptoGetLiveHash_proto_init() {
	if File_CryptoGetLiveHash_proto != nil {
		return
	}
	...
	if !protoimpl.UnsafeEnabled {
		file_CryptoGetLiveHash_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_CryptoGetLiveHash_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_CryptoGetLiveHash_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_CryptoGetLiveHash_proto_goTypes,
		DependencyIndexes: file_CryptoGetLiveHash_proto_depIdxs,
		MessageInfos:      file_CryptoGetLiveHash_proto_msgTypes,
	}.Build()
	File_CryptoGetLiveHash_proto = out.File
	file_CryptoGetLiveHash_proto_rawDesc = nil
	file_CryptoGetLiveHash_proto_goTypes = nil
	file_CryptoGetLiveHash_proto_depIdxs = nil
}
