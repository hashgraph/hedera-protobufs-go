...
func (x *ContractGetBytecodeQuery) Reset() {
	*x = ContractGetBytecodeQuery{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ContractGetBytecode_proto_msgTypes[0]
...
func (*ContractGetBytecodeQuery) Descriptor() ([]byte, []int) {
	return file_ContractGetBytecode_proto_rawDescGZIP(), []int{0}
}
...
func (x *ContractGetBytecodeResponse) Reset() {
	*x = ContractGetBytecodeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ContractGetBytecode_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ContractGetBytecodeResponse) Descriptor() ([]byte, []int) {
	return file_ContractGetBytecode_proto_rawDescGZIP(), []int{1}
}
...
var file_ContractGetBytecode_proto_rawDesc = []byte{
	,
	...
	0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x49, 0x44, 0x22, 0x68, 0x0a, 0x1b, 0x43, 0x6f, 0x6e, 0x74,
	...
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x62, 0x79, 0x74, 0x65, 0x63, 0x6f,
	0x64, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x62, 0x79, 0x74, 0x65, 0x63, 0x6f,
	0x64, 0x65, 0x42, 0x26, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e, 0x68, 0x65, 0x64, 0x65, 0x72, 0x61,
...
var (
	file_ContractGetBytecode_proto_rawDescOnce sync.Once
	file_ContractGetBytecode_proto_rawDescData = file_ContractGetBytecode_proto_rawDesc
)

func file_ContractGetBytecode_proto_rawDescGZIP() []byte {
	file_ContractGetBytecode_proto_rawDescOnce.Do(func() {
		file_ContractGetBytecode_proto_rawDescData = protoimpl.X.CompressGZIP(file_ContractGetBytecode_proto_rawDescData)
	})
	return file_ContractGetBytecode_proto_rawDescData
}

var file_ContractGetBytecode_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_ContractGetBytecode_proto_goTypes = []interface{}{
...
var file_ContractGetBytecode_proto_depIdxs = []int32{
...
func init() { file_ContractGetBytecode_proto_init() }
func file_ContractGetBytecode_proto_init() {
	if File_ContractGetBytecode_proto != nil {
		return
	}
	...
	if !protoimpl.UnsafeEnabled {
		file_ContractGetBytecode_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ContractGetBytecode_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ContractGetBytecode_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ContractGetBytecode_proto_goTypes,
		DependencyIndexes: file_ContractGetBytecode_proto_depIdxs,
		MessageInfos:      file_ContractGetBytecode_proto_msgTypes,
	}.Build()
	File_ContractGetBytecode_proto = out.File
	file_ContractGetBytecode_proto_rawDesc = nil
	file_ContractGetBytecode_proto_goTypes = nil
	file_ContractGetBytecode_proto_depIdxs = nil
}
