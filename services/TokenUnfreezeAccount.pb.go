...
// 	protoc        v3.12.4
// source: TokenUnfreezeAccount.proto
...
func (x *TokenUnfreezeAccountTransactionBody) Reset() {
	*x = TokenUnfreezeAccountTransactionBody{}
	if protoimpl.UnsafeEnabled {
		mi := &file_TokenUnfreezeAccount_proto_msgTypes[0]
...
func (*TokenUnfreezeAccountTransactionBody) Descriptor() ([]byte, []int) {
	return file_TokenUnfreezeAccount_proto_rawDescGZIP(), []int{0}
}
...
var file_TokenUnfreezeAccount_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x55, 0x6e, 0x66, 0x72, 0x65, 0x65, 0x7a, 0x65, 0x41,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x77, 0x0a, 0x23, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x55, 0x6e,
	0x66, 0x72, 0x65, 0x65, 0x7a, 0x65, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x54, 0x72, 0x61,
	...
	0x75, 0x6e, 0x74, 0x49, 0x44, 0x52, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x26,
...
var (
	file_TokenUnfreezeAccount_proto_rawDescOnce sync.Once
	file_TokenUnfreezeAccount_proto_rawDescData = file_TokenUnfreezeAccount_proto_rawDesc
)

func file_TokenUnfreezeAccount_proto_rawDescGZIP() []byte {
	file_TokenUnfreezeAccount_proto_rawDescOnce.Do(func() {
		file_TokenUnfreezeAccount_proto_rawDescData = protoimpl.X.CompressGZIP(file_TokenUnfreezeAccount_proto_rawDescData)
	})
...
func init() { file_TokenUnfreezeAccount_proto_init() }
func file_TokenUnfreezeAccount_proto_init() {
	if File_TokenUnfreezeAccount_proto != nil {
		return
	}
	file_BasicTypes_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_TokenUnfreezeAccount_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_TokenUnfreezeAccount_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_TokenUnfreezeAccount_proto_goTypes,
		DependencyIndexes: file_TokenUnfreezeAccount_proto_depIdxs,
		MessageInfos:      file_TokenUnfreezeAccount_proto_msgTypes,
	}.Build()
	File_TokenUnfreezeAccount_proto = out.File
	file_TokenUnfreezeAccount_proto_rawDesc = nil
	file_TokenUnfreezeAccount_proto_goTypes = nil
	file_TokenUnfreezeAccount_proto_depIdxs = nil
}
