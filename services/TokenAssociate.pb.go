...
func (x *TokenAssociateTransactionBody) Reset() {
	*x = TokenAssociateTransactionBody{}
	if protoimpl.UnsafeEnabled {
		mi := &file_TokenAssociate_proto_msgTypes[0]
...
func (*TokenAssociateTransactionBody) Descriptor() ([]byte, []int) {
	return file_TokenAssociate_proto_rawDescGZIP(), []int{0}
}
...
var file_TokenAssociate_proto_rawDesc = []byte{
	0x0a, 0x14, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x73, 0x73, 0x6f, 0x63, 0x69, 0x61, 0x74, 0x65,
	...
	0x73, 0x0a, 0x1d, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x73, 0x73, 0x6f, 0x63, 0x69, 0x61, 0x74,
	...
	0x6b, 0x65, 0x6e, 0x73, 0x42, 0x26, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e, 0x68, 0x65, 0x64, 0x65,
...
var (
	file_TokenAssociate_proto_rawDescOnce sync.Once
	file_TokenAssociate_proto_rawDescData = file_TokenAssociate_proto_rawDesc
)

func file_TokenAssociate_proto_rawDescGZIP() []byte {
	file_TokenAssociate_proto_rawDescOnce.Do(func() {
		file_TokenAssociate_proto_rawDescData = protoimpl.X.CompressGZIP(file_TokenAssociate_proto_rawDescData)
	})
	return file_TokenAssociate_proto_rawDescData
}

var file_TokenAssociate_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_TokenAssociate_proto_goTypes = []interface{}{
...
var file_TokenAssociate_proto_depIdxs = []int32{
...
func init() { file_TokenAssociate_proto_init() }
func file_TokenAssociate_proto_init() {
	if File_TokenAssociate_proto != nil {
		return
	}
	file_BasicTypes_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_TokenAssociate_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_TokenAssociate_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_TokenAssociate_proto_goTypes,
		DependencyIndexes: file_TokenAssociate_proto_depIdxs,
		MessageInfos:      file_TokenAssociate_proto_msgTypes,
	}.Build()
	File_TokenAssociate_proto = out.File
	file_TokenAssociate_proto_rawDesc = nil
	file_TokenAssociate_proto_goTypes = nil
	file_TokenAssociate_proto_depIdxs = nil
}
