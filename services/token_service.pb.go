...
var file_token_service_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xcd, 0x0a, 0x0a, 0x0c, 0x54, 0x6f, 0x6b,
...
var file_token_service_proto_depIdxs = []int32{
	...
	2,  // 21: proto.TokenService.createToken:output_type -> proto.TransactionResponse
	2,  // 22: proto.TokenService.updateToken:output_type -> proto.TransactionResponse
	2,  // 23: proto.TokenService.mintToken:output_type -> proto.TransactionResponse
	2,  // 24: proto.TokenService.burnToken:output_type -> proto.TransactionResponse
	2,  // 25: proto.TokenService.deleteToken:output_type -> proto.TransactionResponse
	2,  // 26: proto.TokenService.wipeTokenAccount:output_type -> proto.TransactionResponse
	2,  // 27: proto.TokenService.freezeTokenAccount:output_type -> proto.TransactionResponse
	2,  // 28: proto.TokenService.unfreezeTokenAccount:output_type -> proto.TransactionResponse
	2,  // 29: proto.TokenService.grantKycToTokenAccount:output_type -> proto.TransactionResponse
	2,  // 30: proto.TokenService.revokeKycFromTokenAccount:output_type -> proto.TransactionResponse
	2,  // 31: proto.TokenService.associateTokens:output_type -> proto.TransactionResponse
	2,  // 32: proto.TokenService.dissociateTokens:output_type -> proto.TransactionResponse
	2,  // 33: proto.TokenService.updateTokenFeeSchedule:output_type -> proto.TransactionResponse
	3,  // 34: proto.TokenService.getTokenInfo:output_type -> proto.Response
	3,  // 35: proto.TokenService.getAccountNftInfos:output_type -> proto.Response
	3,  // 36: proto.TokenService.getTokenNftInfo:output_type -> proto.Response
	3,  // 37: proto.TokenService.getTokenNftInfos:output_type -> proto.Response
	2,  // 38: proto.TokenService.pauseToken:output_type -> proto.TransactionResponse
	2,  // 39: proto.TokenService.unpauseToken:output_type -> proto.TransactionResponse
	2,  // 40: proto.TokenService.updateNfts:output_type -> proto.TransactionResponse
	2,  // 41: proto.TokenService.rejectToken:output_type -> proto.TransactionResponse
