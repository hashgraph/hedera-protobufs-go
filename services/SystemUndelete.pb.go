...
func (x *SystemUndeleteTransactionBody) Reset() {
	*x = SystemUndeleteTransactionBody{}
	if protoimpl.UnsafeEnabled {
		mi := &file_SystemUndelete_proto_msgTypes[0]
...
func (*SystemUndeleteTransactionBody) Descriptor() ([]byte, []int) {
	return file_SystemUndelete_proto_rawDescGZIP(), []int{0}
}
...
var file_SystemUndelete_proto_rawDesc = []byte{
	0x0a, 0x14, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x55, 0x6e, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65,
	...
	0x83, 0x01, 0x0a, 0x1d, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x55, 0x6e, 0x64, 0x65, 0x6c, 0x65,
	0x74, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x6f, 0x64,
	0x79, 0x12, 0x27, 0x0a, 0x06, 0x66, 0x69, 0x6c, 0x65, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x0d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x49, 0x44,
	0x48, 0x00, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x65, 0x49, 0x44, 0x12, 0x33, 0x0a, 0x0a, 0x63, 0x6f,
	...
	0x44, 0x48, 0x00, 0x52, 0x0a, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x49, 0x44, 0x42,
...
var (
	file_SystemUndelete_proto_rawDescOnce sync.Once
	file_SystemUndelete_proto_rawDescData = file_SystemUndelete_proto_rawDesc
)

func file_SystemUndelete_proto_rawDescGZIP() []byte {
	file_SystemUndelete_proto_rawDescOnce.Do(func() {
		file_SystemUndelete_proto_rawDescData = protoimpl.X.CompressGZIP(file_SystemUndelete_proto_rawDescData)
	})
	return file_SystemUndelete_proto_rawDescData
}

var file_SystemUndelete_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_SystemUndelete_proto_goTypes = []interface{}{
...
var file_SystemUndelete_proto_depIdxs = []int32{
...
func init() { file_SystemUndelete_proto_init() }
func file_SystemUndelete_proto_init() {
	if File_SystemUndelete_proto != nil {
		return
	}
	file_BasicTypes_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_SystemUndelete_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_SystemUndelete_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_SystemUndelete_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_SystemUndelete_proto_goTypes,
		DependencyIndexes: file_SystemUndelete_proto_depIdxs,
		MessageInfos:      file_SystemUndelete_proto_msgTypes,
	}.Build()
	File_SystemUndelete_proto = out.File
	file_SystemUndelete_proto_rawDesc = nil
	file_SystemUndelete_proto_goTypes = nil
	file_SystemUndelete_proto_depIdxs = nil
}
