...
func (x *ScheduleSignTransactionBody) Reset() {
	*x = ScheduleSignTransactionBody{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ScheduleSign_proto_msgTypes[0]
...
func (*ScheduleSignTransactionBody) Descriptor() ([]byte, []int) {
	return file_ScheduleSign_proto_rawDescGZIP(), []int{0}
}
...
var file_ScheduleSign_proto_rawDesc = []byte{
	0x0a, 0x12, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x53, 0x69, 0x67, 0x6e, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x10, 0x42, 0x61, 0x73,
	0x69, 0x63, 0x54, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x50, 0x0a,
	0x1b, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x53, 0x69, 0x67, 0x6e, 0x54, 0x72, 0x61,
...
var (
	file_ScheduleSign_proto_rawDescOnce sync.Once
	file_ScheduleSign_proto_rawDescData = file_ScheduleSign_proto_rawDesc
)

func file_ScheduleSign_proto_rawDescGZIP() []byte {
	file_ScheduleSign_proto_rawDescOnce.Do(func() {
		file_ScheduleSign_proto_rawDescData = protoimpl.X.CompressGZIP(file_ScheduleSign_proto_rawDescData)
	})
	return file_ScheduleSign_proto_rawDescData
}

var file_ScheduleSign_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ScheduleSign_proto_goTypes = []interface{}{
	(*ScheduleSignTransactionBody)(nil), // 0: proto.ScheduleSignTransactionBody
	(*ScheduleID)(nil),                  // 1: proto.ScheduleID
}
var file_ScheduleSign_proto_depIdxs = []int32{
...
func init() { file_ScheduleSign_proto_init() }
func file_ScheduleSign_proto_init() {
	if File_ScheduleSign_proto != nil {
		return
	}
	file_BasicTypes_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_ScheduleSign_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ScheduleSign_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ScheduleSign_proto_goTypes,
		DependencyIndexes: file_ScheduleSign_proto_depIdxs,
		MessageInfos:      file_ScheduleSign_proto_msgTypes,
	}.Build()
	File_ScheduleSign_proto = out.File
	file_ScheduleSign_proto_rawDesc = nil
	file_ScheduleSign_proto_goTypes = nil
	file_ScheduleSign_proto_depIdxs = nil
}
